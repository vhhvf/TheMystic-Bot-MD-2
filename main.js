...
conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ مع السلامه تخرج يجي مليون غيرك 😉✨* \n*╚══════════════*'
conn.spromote = '*@user تم رفعك مشرف!!*'
conn.sdemote = '*@user تم تنزيلك من الاشراف !!*'
...
let bio = `🤖 ᴛɪᴇᴍᴘᴏ ᴀᴄᴛɪᴠᴏ: ${uptime} ┃ 👑 ʙʏ 𓀂𝑬𝑴𝑷𝑬𝑹𝑶𝑹𝑨𝑵𝑼𝑺𓀋 ┃ 🔗 ᴄᴜᴇɴᴛᴀs ᴏғᴄ: https://youtube.com/@emperoranus7621-team`
